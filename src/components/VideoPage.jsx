      ...
      <div className="absolute top-[182px] left-1/2 transform -translate-x-1/2 w-[320px] h-[526px] rounded-t-[160px] overflow-hidden">
              {isLoading ? (
                ...
                <div className="relative w-full h-full">
                  ...
                  {/* Normal Mode Fullscreen Button */}
                  {!isFullscreen && (
                    <button
                      onClick={toggleFullscreen}
                      className="absolute top-2 right-2 bg-primary-teal text-white p-3 rounded-full hover:bg-opacity-80 transition-all shadow-lg"
                      title="Toàn màn hình"
                      style={{ zIndex: 9999 }}
                    >
                  ...
                  {isFullscreen && (
                    <button
                      onClick={toggleFullscreen}
                      className="fixed top-4 right-4 bg-red-500 text-white p-4 rounded-full hover:bg-red-600 transition-all shadow-xl z-[99999]"
